...
public class Jumpo implements Game, Runnable {
    ...
    private void StartRound() {
        ...
        channel.broadcastButlerMessage(String.format("°18BB°_Zeige dem Knuddel den Weg bevor es zu spät ist:##°>center<>jumpo/%s...border_3.png<°#°>left<°", id));
        playing = true;
