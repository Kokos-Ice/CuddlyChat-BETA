...
import java.util.ArrayList;
    ...
    public class KTab
    {
        ...
        public KTab(String header, String headerRight, String tab, String tabHeader, String text)
        {
            this(0);
            tabs.add(new TabSite(header, headerRight, tab, tabHeader, text));
        }
        ...
        public KTab(int paramShowTab, String _title, String _topRightTitle, String _tabTitle)
        {
        ...
        {
            tabs.add(new TabSite(((TabSite)tabs.get(0)).title, ((TabSite)tabs.get(0)).topRightTitle, _tabTitle, _headerTitle, _message));
        }
        ...
        public String getSwitchTab()
        {
            ...
            for (Object objts : tabs)
            {
				...
				sites.append("°>{switchtab}").append(index).append("<°");
				 ...
				 sites.append("°BB12>{table|w7|w4<>").append(url).append("layout/line_l.png<°");
				...
				if(ts.headerTitle != null && !ts.headerTitle.equals("null")) {
					sites.append("°1>{table|0|w1|w1<>{tc}<>").append(url).append("layout/boxb_tl.png<>").append(url).append("layout/boxb_tc...w_0.xrepeat.gif<° ");
            		...
            		sites.append( "°>JUSTIFY<°").append(ts.message);
            		sites.append("°>LEFT<°#§");
            	}
            }
        ...
        private String activeTab(int index)
        {
            ...
            for (Object objts : tabs)
            {
                TabSite ts = (TabSite)objts;
                ind++;
                String strTab = "°>"+this.url+"layout/tab_i_l...w_8.mx_-1.png<>"+this.url+"layout/tab_i_c...w_0.xrepeat.png<" + (ts.tabTitle.startsWith(">") ? "" : ">_h") + ts.tabTitle + "|/tp-showtab " + ind + "<>{noxrep}<>"+this.url+"layout/tab_i_r.png<°";
                if (ind == index)
                    strTab = "°>"+this.url+"layout/tab_a_l...w_8.mx_-1.png<>"+this.url+"layout/tab_a_c...w_0.xrepeat.png<" + (ts.tabTitle.startsWith(">") ? "" : ">_h") + ts.tabTitle + "|/tp-showtab " + ind + "<>{noxrep}<>"+this.url+"layout/tab_a_r.png<°";
...
/* ALTE KTab Java von Sunny oder Chiller, ohne W2 */
