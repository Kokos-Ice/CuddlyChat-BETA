    ...
    public class PopupWhois3 {
            private String title, subtitle, message;
            private int width, height;
            private List<Panel> panels;
            private String opcode, parameter;
     
            public PopupWhois3(String title, String subtitle, String message, int width,
                            int height) {
                    this.title = title;
    ...
    String action = PacketCreator.paketfake("k\0"+title+"õf\0\0\0hÿÿÿãCp~õBNp~õU-õU\0\0\nBãSp~õbëëÿU-õU\0\0\nBãCp~õBSp~õbëëÿGBBBBp~õbëëÿFp~õGABBBp~õbëëÿBCbõcedbgOhÿÿÿãEp~õbëëÿU-õU\0\0\0BãWp~õbëëÿU-õU\0\0\0BãããããCp~õBNpBNpBWpUpics/layout/boxS_tl.pngõU\0\0BãCpUpics/layout/boxS_tc.pngõU\0\0BãEpUpics/layout/boxS_tr.pngõU\0\0BããWpUpics/layout/boxS_cl.pngõU\0\0BãEpUpics/layout/boxS_cr.pngõU\0\0BãSpBWpUpics/layout/boxS_bl.pngõU\0\0BãCpUpics/layout/boxS_bc.pngõU\0\0BãEpUpics/layout/boxS_br.pngõU\0\0BããCp~õGABBBp~õBCl"+subtitle+"õbgUf\0\0\0hÞÞÿããããCp~õBCp~õBNp~õU-õU\0\0BãSp~õbëëÿU-õU\0\0BãCp~õBCc°R>{linkhovercolor}<r°"+message+"°>{linkhovercolorreset}<°õ~tpõ"+buffer2+"f\0\0\0hÿÿÿipics/layout/bg_trend.pngõÿÿããEp~õUpics/layout/bg_trend.pngõU\0\0BãWp~õUpics/layout/bg_trend.pngõU\0\0BãããããEp~õUpics/layout/bg_trend.pngõU\0\n\0BãWp~õUpics/layout/bg_trend.pngõU\0\n\0Bããã");
